...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String video_path = "D:\\Minio\\LocalData\\1.mp4";
    String mp4_name = "1.avi";
    String mp4folder_path = "C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe";
...
//        Process p = builder.start();
        ...
        String mp4_name = "1.avi";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Minio\\LocalData\\1.avi";
        //创建工具类对象
